...
public class OnlineCourse extends Course
{
	...
	{
		return "Title = " + "\"" + getTitle() + "\"" + ", Instructor = " + "\""
				+ getInstructor() + "\"" + ", Price = " + getPrice()
				+ ", CourseType = " + getCType() + ", startDate = "
				+ getStartDate() + ", endDate = " + getEndDate()
				+ ", examProctor = " + "\"" + examProctor + "\"" + ", video = "
				+ video + ", numberOfChapters = " + numberOfChapters + "\r\n";
	}
