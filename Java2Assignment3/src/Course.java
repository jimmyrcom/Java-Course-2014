...
public class Course
{
    ...
    Course(String title, String instructor, double price, Date startDate, Date endDate)
    {
        setEndDate(endDate);
    ...
    public double calculateCharge(Customer.CustomerType c)
    {
    	...
    	switch (this.cType) {
			case PROGRAMMING:
			case MATHEMATICS:
				total= 99+price; break;
			case MISC:                        
				total= 39+price; break;
			default:                           
				total= 59+price;
    	}
    	return total;
    ...
    {
        return "Course(title:String = " + "\"" + title + "\"" + ", instructor:String = " + "\"" +
               instructor + "\"" + ", price:double = " + price + ", cType:CourseType = " +
               cType + ", startDate:Date = " + startDate + ", endDate:Date = " + endDate + ")";
    }
